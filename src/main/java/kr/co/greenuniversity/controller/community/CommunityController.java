...
public class CommunityController {
    ...
    public String view1(int no, Model model) {
    ...
    public String view2(int no, Model model) {
    ...
    public String view3(int no, Model model) {
        Community2DTO communityDTO = communityService.findById2(no);
        model.addAttribute(communityDTO);
    ...
    public String view4(int no, Model model) {
        Community2DTO communityDTO = communityService.findById2(no);
        model.addAttribute(communityDTO);
    ...
    public String write(Community1DTO communityDTO, HttpServletRequest req) {
